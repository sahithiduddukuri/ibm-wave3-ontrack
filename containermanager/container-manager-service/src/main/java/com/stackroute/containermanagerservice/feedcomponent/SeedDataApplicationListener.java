...
public class SeedDataApplicationListener implements ApplicationListener<ContextRefreshedEvent>
{
    ...
    Container feedContainerData=new Container();
    ...
    public void onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent)
    {
        ...
        feedContainerData.setConatinerId(environment.getProperty("container.1.containerId"));
        feedContainerData.setDate(environment.getProperty("container.1.date"));
        feedContainerData.setSlotNumber(environment.getProperty("container.1.slotNumber"));
    }
}
