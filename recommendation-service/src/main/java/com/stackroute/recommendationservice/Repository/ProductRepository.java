...
public interface ProductRepository extends Neo4jRepository<Product, String> {
    ...
    @Query("Merge (p:Product) SET p.productId={productId},p.productName={productName},p.productType={productType},p.productTypeId={productTypeId},p.imageURL={imageURL},p.mrp={mrp},p.price={price},p.dimension={dimension},p.weight={weight},p.size={size},p.gender={gender},p.description={description},p.brand={brand},p.brandId={brandId},p.colour={colour}")
